...
function updatePageText() {
    try {
        ...
        const incentLink = document.querySelector('[data-page="incentivos"]');
        if (incentLink) incentLink.textContent = t('incentives');

        const tzLabel = document.querySelector('label[for="timezoneSelect"]');
        if (tzLabel) tzLabel.textContent = t('timezone');

        const timezoneSelect = document.getElementById('timezoneSelect');
        if (timezoneSelect && timezoneSelect.querySelector('option[value="auto"]')) {
...
export { t, updateLanguage, updatePageText, initializeURLRouting, updateURLForPage, detectTimezone, updateDetectedTimezone, convertToTimezone, getIncentiveStatus, getTimeRemaining, updateCurrentTimezoneInfo, ultimoIncentivoPeru, selectedTimezone, currentTimezone, setTimezone };
