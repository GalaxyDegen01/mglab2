        ...
        currentContainer.innerHTML = `
            <div class="current-incentive-section">
                ...
                <div class="current-incentive-content">
                    ...
                    <div class="current-incentive-info"><div class="current-incentive-name">${currentIncentive.nombre}</div><div class="current-incentive-description">${currentIncentive.descripcion}</div><div class="current-incentive-time"><div class="current-incentive-time-label">${t('ends_in')}:</div><div id="currentCountdownValue" class="current-incentive-time-value">${currentIncentive.timeRemaining}</div><div class="current-incentive-time-label" style="margin-top: 1rem;">${t('end')}: ${currentIncentive.endConverted.date} ${currentIncentive.endConverted.time}</div></div></div>
                </div>
            </div>
        `;
        startActiveIncentiveTimer(currentIncentive.endDate);
    } else {
...
function startActiveIncentiveTimer(endDate) {
    const countdownElement = document.getElementById('currentCountdownValue');
